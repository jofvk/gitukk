                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update',$rsetBarangMasuk->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ old('tgl_masuk',$rsetBarangMasuk->tgl_masuk) }}" placeholder="Masukkan tgl_masuk">
                            ...
                            <div class="form-group">
                                <label for="barang_id" class="font-weight-bold">BARANG_ID</label>
                                <select name="barang_id" id="barang_id" class="form-control">
                                    @foreach($barangId as $barangIdrow)
                                        <option value="{{ $barangIdrow->id }}" @if($barangIdrow->id == old('barang_id', $rsetBarangMasuk->barang_id)) selected @endif>
                                            {{ $barangIdrow->id }} - {{ $barangIdrow->merk }}
                                        </option>
                                    @endforeach
                                </select>
